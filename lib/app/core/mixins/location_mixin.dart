    ...
    showDialog(
        ...
        builder: (contextDialog) {
          return AlertDialog(
            title: const Text('Precisamos da sua autorização'),
            content: const Text(
                'Para realizar a busca da sua localização, precisamos que você autorize a utilização, clique no botão abrir configurações e autorize a utilização e clique novamente em localização atual'),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.pop(contextDialog);
